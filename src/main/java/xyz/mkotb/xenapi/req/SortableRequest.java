...
public interface SortableRequest extends BaseRequest {
    default String sortField() {
        return castGet("order_by", String.class);
    }

    default void sortField(String orderField) {
        set("order_by", orderField);
    }

    default SortDirection sortDirection() {
        String str = castGet("order", String.class);
    ...
    default void sortDirection(SortDirection direction) {
